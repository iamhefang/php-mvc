...
abstract class BaseModel implements IMapObject, IJsonObject, JsonSerializable, IModel2
{
	private $exist = false;
	 ...
	 * @throws SqlException
	 */
	public static function find($where): BaseModel
	{
	 ...
	 * @return BaseModel
	 */
	private static function _row2model($row): BaseModel
	{
		$class = self::_checkClass(__FUNCTION__);
	...
	private static function _newModel(): BaseModel
	{
		$class = self::_checkClass(__FUNCTION__);
		return new $class();
	}
	 ...
	 * @return BaseModel
	 */
	public function setValue2Field($value, string $field): BaseModel
	{
	 ...
	 * @return $this
	 */
	public function setValue2Prop($value, string $prop): BaseModel
	{
		try {
